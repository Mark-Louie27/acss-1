            ...
            <div class="flex flex-col sm:flex-row items-center justify-between">
                <div class="flex items-center space-x-6 mb-4 sm:mb-0">
                    ...
                    <div class="text-center sm:text-left">
                        ...
                        <p class="text-sm font-medium text-orange-100"><?php echo htmlspecialchars($user['college_name'], ENT_QUOTES, 'UTF-8'); ?></p>
                                ...
                                <div class="specialization-card p-4 rounded-lg" data-index="<?php echo $index; ?>">
                                    <div class="flex items-start justify-between mb-3">
                                        ...
                                        <div class="flex space-x-1">
                                            <form method="POST" action="/dean/profile" style="display:inline;" class="edit-form" data-index="<?php echo $index; ?>">
