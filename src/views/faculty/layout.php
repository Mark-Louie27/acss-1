            ...
            <div class="flex items-center space-x-4">
                ...
                <div class="dropdown relative">
                    ...
                    <div class="dropdown-menu right-0 mt-2">
                        <a href="/faculty/profile" class="flex items-center px-4 py-2 text-gray-300 hover:bg-gray-600 hover:text-gold-300">
                            <i class="fas fa-user w-5 mr-2"></i> Profile
                        </a>
                        <a href="/faculty/settings" class="flex items-center px-4 py-2 text-gray-300 hover:bg-gray-600 hover:text-gold-300">
                            <i class="fas fa-cog w-5 mr-2"></i> Settings
                        </a>
                        <a href="/faculty/logout" class="flex items-center px-4 py-2 text-gray-300 hover:bg-gray-600 hover:text-gold-300">
    ...
    <aside id="sidebar" class="sidebar w-64 text-white fixed h-full overflow-y-auto transition-all duration-300 transform -translate-x-full md:translate-x-0 top-0 mt-16 md:mt-0">
        ...
        <div class="absolute bottom-0 left-0 right-0 p-4 bg-gray-900 border-t border-gray-700 hidden md:block">
            <div class="flex items-center justify-between text-xs text-gray-400">
                ...
                <a href="/faculty/system/status" class="text-gold-400 hover:text-gold-300 transition-all duration-300">
                ...
                <nav class="flex mb-5 text-sm" aria-label="Breadcrumb">
                    <ol class="inline-flex items-center space-x-1 md:space-x-3">
                        <li class="inline-flex items-center">
                            <a href="/faculty/dashboard" class="inline-flex items-center text-gray-500 hover:text-gold-400">
