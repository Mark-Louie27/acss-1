...
<body class="bg-gray-200 font-sans">
            ...
            <div class="flex items-center space-x-4">
                ...
                <div class="dropdown relative">
                    ...
                    <div class="dropdown-menu right-0 mt-2">
                        <a href="/faculty/profile" class="flex items-center px-4 py-2 text-gray-300 hover:bg-gray-600 hover:text-yellow-300">
                            <i class="fas fa-user w-5 mr-2"></i> Profile
                        </a>
                        <a href="/faculty/settings" class="flex items-center px-4 py-2 text-gray-300 hover:bg-gray-600 hover:text-yellow-300">
                            <i class="fas fa-cog w-5 mr-2"></i> Settings
                        </a>
                        <a href="/faculty/logout" class="flex items-center px-4 py-2 text-gray-300 hover:bg-gray-600 hover:text-yellow-300">
    ...
    <aside id="sidebar" class="sidebar w-64 text-white fixed h-full overflow-y-auto transition-all duration-300 transform -translate-x-full md:translate-x-0 top-0 mt-16 md:mt-0">
        ...
        <div class="py-6 px-6 flex flex-col items-center justify-center border-b border-gray-700 bg-gray-900 md:block">
            ...
            <p class="text-xs text-gray-400 mt-1 hidden md:block">Faculty Management System</p>
        </div>
        ...
        <nav class="mt-4 px-2">
            ...
            <a href="/faculty/dashboard" class="nav-item flex items-center px-4 py-3 text-gray-200 rounded-lg mb-1 hover:text-white transition-all duration-300 <?php echo strpos($currentUri, '/faculty/dashboard') !== false ? 'active-nav bg-gray-800 text-yellow-400' : ''; ?>">
                <i class="fas fa-tachometer-alt w-5 mr-3 <?php echo strpos($currentUri, '/faculty/dashboard') !== false ? 'text-yellow-400' : 'text-gray-400'; ?>"></i>
                <span>Dashboard</span>
            </a>
            ...
            <a href="/faculty/schedule" class="nav-item flex items-center px-4 py-3 text-gray-200 rounded-lg mb-1 hover:text-white transition-all duration-300 <?php echo strpos($currentUri, '/faculty/schedule') !== false ? 'active-nav bg-gray-800 text-yellow-400' : ''; ?>">
                <i class="fas fa-calendar-alt w-5 mr-3 <?php echo strpos($currentUri, '/faculty/schedule') !== false ? 'text-yellow-400' : 'text-gray-400'; ?>"></i>
            ...
            <a href="/faculty/profile" class="nav-item flex items-center px-4 py-3 text-gray-200 rounded-lg mb-1 hover:text-white transition-all duration-300 <?php echo strpos($currentUri, '/faculty/profile') !== false ? 'active-nav bg-gray-800 text-yellow-400' : ''; ?>">
                <i class="fas fa-user-circle w-5 mr-3 <?php echo strpos($currentUri, '/faculty/profile') !== false ? 'text-yellow-400' : 'text-gray-400'; ?>"></i>
                <span>Profile</span>
            </a>
        </nav>
                ...
                <nav class="flex mb-5 text-sm" aria-label="Breadcrumb">
                    <ol class="inline-flex items-center space-x-1 md:space-x-3">
                        <li class="inline-flex items-center">
                            <a href="/faculty/dashboard" class="inline-flex items-center text-gray-500 hover:text-yellow-400">
