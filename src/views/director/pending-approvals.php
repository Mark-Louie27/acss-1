...
<div>
    ...
    <div class="bg-gradient-to-r from-gray-800 to-gray-900 text-white rounded-xl p-6 sm:p-8 mb-8 shadow-lg relative overflow-hidden">
        ...
        <div class="flex flex-col sm:flex-row items-start sm:items-center justify-between">
            <div>
                <h1 class="text-2xl sm:text-3xl font-bold">University Schedule Management</h1>
                <p class="text-gray-300 mt-2">All Colleges and Departments</p>
            </div>
            <div class="flex items-center text-sm text-gray-300 mt-4 sm:mt-0">
                ...
                <?php echo htmlspecialchars($currentSemester['semester_name'] ?? 'No Semester'); ?>
            </div>
        </div>
    </div>
    ...
    <div class="bg-white rounded-lg shadow-md p-6 mb-6">
        <div class="flex flex-col md:flex-row gap-4 mb-4">
            <select id="department-filter" class="p-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-yellow-500 flex-1 md:max-w-xs">
                ...
                <?php
                // Group departments by college for the dropdown
                $colleges = [];
    ...
    <div id="approveModal" class="fixed inset-0 bg-gray-600 bg-opacity-50 flex justify-center hidden overflow-y-auto z-50">
    ...
    <div id="rejectModal" class="fixed inset-0 bg-gray-600 bg-opacity-50 hidden flex justify-center overflow-y-auto z-50">
        <div class="relative top-20 mx-auto p-5 border w-96 shadow-lg rounded-md bg-white">
                ...
                <thead class="bg-gray-50">
                    <tr>
                        <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">
                            <i class="fas fa-university mr-1 text-yellow-500"></i> College
                        </th>
                        <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">
