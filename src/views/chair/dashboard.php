    ...
    <div class=" gap-6 lg:gap-8 mb-8">
        ...
        <div class="lg:col-span-2">
            <div class="bg-white rounded-xl shadow-md p-6 h-full">
                ...
                <!-- This wrapper is critical for table responsiveness -->
                <div class="overflow-x-auto rounded-lg shadow-inner">
                    <table class="min-w-full divide-y divide-gray-200">
                        <thead class="bg-yellow-600 text-white sticky top-0">
                            <tr>
                                <th class="px-3 py-2 sm:px-6 sm:py-3 text-left text-xs font-medium uppercase tracking-wider">Course Code</th>
                                <th class="px-3 py-2 sm:px-6 sm:py-3 text-left text-xs font-medium uppercase tracking-wider">Course Name</th>
                                <th class="px-3 py-2 sm:px-6 sm:py-3 text-left text-xs font-medium uppercase tracking-wider">Section</th>
                                <th class="px-3 py-2 sm:px-6 sm:py-3 text-left text-xs font-medium uppercase tracking-wider">Room</th>
                                <th class="px-3 py-2 sm:px-6 sm:py-3 text-left text-xs font-medium uppercase tracking-wider">Day</th>
                                <th class="px-3 py-2 sm:px-6 sm:py-3 text-left text-xs font-medium uppercase tracking-wider">Time</th>
                                <th class="px-3 py-2 sm:px-6 sm:py-3 text-left text-xs font-medium uppercase tracking-wider">Type</th>
                            </tr>
                        </thead>
                                ...
                                <?php foreach ($schedules as $schedule): ?>
                                    <tr class="hover:bg-yellow-50 transition-colors">
                                        <td class="px-3 py-2 sm:px-6 sm:py-4 whitespace-nowrap">
                                            <div class="text-xs sm:text-sm font-medium text-gray-900"><?php echo htmlspecialchars($schedule['course_code'] ?? 'N/A'); ?></div>
                                        </td>
                                        <td class="px-3 py-2 sm:px-6 sm:py-4 whitespace-nowrap">
                                            <div class="text-xs sm:text-sm text-gray-500"><?php echo htmlspecialchars($schedule['course_name'] ?? 'N/A'); ?></div>
                                        </td>
                                        <td class="px-3 py-2 sm:px-6 sm:py-4 whitespace-nowrap">
                                        ...
                                        <td class="px-3 py-2 sm:px-6 sm:py-4 whitespace-nowrap">
                                            <div class="text-xs sm:text-sm text-gray-500"><?php echo htmlspecialchars($schedule['room_name'] ?? 'TBD'); ?></div>
                                        </td>
                                        <td class="px-3 py-2 sm:px-6 sm:py-4 whitespace-nowrap">
                                            <div class="text-xs sm:text-sm font-medium text-gray-900"><?php echo htmlspecialchars($schedule['day_of_week'] ?? 'N/A'); ?></div>
                                        </td>
                                        <td class="px-3 py-2 sm:px-6 sm:py-4 whitespace-nowrap">
                                            <div class="text-xs sm:text-sm text-gray-500"><?php echo htmlspecialchars($schedule['start_time'] . ' - ' . $schedule['end_time'] ?? 'N/A'); ?></div>
                                        </td>
                                        <td class="px-3 py-2 sm:px-6 sm:py-4 whitespace-nowrap">
                                            <div class="text-xs sm:text-sm text-gray-500"><?php echo htmlspecialchars($schedule['schedule_type'] ?? 'N/A'); ?></div>
                                        </td>
                                    </tr>
                                <?php endforeach; ?>
                            <?php else: ?>
